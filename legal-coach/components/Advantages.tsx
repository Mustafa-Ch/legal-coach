...
const Advantages = ({ bottom = 0, left = 0, w = 0 }: any) => {
  return (
    <div className="w-full min-h-screen bg-[#FEFEFE] px-4 sm:px-6 lg:px-10 mx-auto flex flex-col gap-5 items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 p-4 sm:p-6 lg:p-8 w-full">
        <div className="lg:col-span-8 md:col-span-2 bg-[#F0F4FA] border rounded-3xl p-4 sm:p-6 relative flex flex-col justify-between h-auto lg:h-[300px]">
          <div>
        ...
        <div className="lg:col-span-4 md:col-span-2 bg-[#F0F4FA] border rounded-3xl p-4 sm:p-6 flex flex-col justify-between h-auto lg:h-[300px]">
          <div>
            ...
            <p className="text-[12px] sm:text-[12px] text-[#868589]">
              On routine tasks.
            </p>
            <Image
              src={graphs}
        ...
        <div className="lg:col-span-5 md:col-span-2 flex flex-col gap-4">
          <div className="h-auto sm:h-[120px] border rounded-3xl p-4 bg-[#F0F4FA] flex flex-col justify-between">
            <h3 className="font-inter font-normal text-[18px] sm:text-[20.88px] leading-[28px] sm:leading-[35.2px] text-[#120E14]">
              Fast
            </h3>
            <p className="font-inter w-full sm:w-[80%] font-normal text-[12px] sm:leading-[22.4px] text-[#868589]">
              The fastest online MLC service, ideal for avoiding expenses and
              appointments.
            </p>
          </div>
          <div className="w-full lg:h-[200px] border bg-[#F0F4FA] rounded-3xl p-4 sm:p-6">
            <Image
              src={file}
              alt="alt"
        ...
        <div className="lg:col-span-3 md:col-span-2 bg-[#F0F4FA] border rounded-3xl p-4 sm:p-6 flex flex-col justify-between h-auto lg:h-[330px]">
          <div>
            <h3 className="font-inter font-normal text-[18px] sm:text-[20.13px] leading-[28px] sm:leading-[35.2px] text-[#120E14]">
              24/7 Support
            </h3>
            <p className="font-inter font-normal w-full sm:w-[75%] text-[12px] sm:leading-[22.4px] text-[#868589]">
          ...
          <Image
            src={icons}
            alt="alt"
            className="w-full sm:w-[400px] mt-4 sm:mt-6 mx-auto"
          />
        </div>

        <div className="lg:col-span-4 md:col-span-2 bg-[#F0F4FA] border rounded-3xl p-4 sm:p-6 flex flex-col justify-end h-auto lg:h-[330px]">
